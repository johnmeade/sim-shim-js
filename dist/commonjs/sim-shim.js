...
var _createClass = (function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; })(); // import SimShimPlot from './sim-shim-plot.js';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SimShim = undefined;

require('./sim-shim-plot.js');

var _simShimPlotCtx = require('./sim-shim-plot-ctx');
...
var SimShim = exports.SimShim = (function () {
  function SimShim(plotTarget) {
    ...
    if (SimShimPlot === undefined) {
      console.log(SimShimPlot);
      throw (/*A*/"TANTRUM"
      );
    }
    ...
    // create plot context
    this.plotCtx = new _simShimPlotCtx2.default(renderer, scene, camera, controls, light);
